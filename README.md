...
```bash
# 1. Clone
git clone <your-fork-url> kimono-seo
cd kimono-seo
...
> Placeholders — add real screenshots under `docs/screenshots/`.

![Dashboard](docs/screenshots/dashboard.png)
![SEO Engine](docs/screenshots/seo-engine.png)
![On-page audit](docs/screenshots/onpage-audit.png)
![AI citations / GEO](docs/screenshots/ai-citations.png)
